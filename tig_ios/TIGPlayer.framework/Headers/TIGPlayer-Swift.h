...
/// contents名
@property (nonatomic, copy) NSString * _Nonnull contentsDesc;
/// contentsタイトル
@property (nonatomic, copy) NSString * _Nonnull contentsTitle;
/// グループ識別子
@property (nonatomic, copy) NSString * _Nonnull groupIdent;
/// contents動画URL
...
/// @ACCESS_OPEN
SWIFT_CLASS("_TtC9TIGPlayer12TIGAnalytics")
@interface TIGAnalytics : UIWebView <UIWebViewDelegate>
/// 画面に表示しないのでframeは常に0
/// \param frame frame
///
...
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
/// 設定
- (void)configWithContentsId:(NSString * _Nonnull)contentsId;
/// 通知の受付を有効に
...
/// webViewNaviBar
@property (nonatomic, strong) UIView * _Nonnull webViewNaviBar;
/// 一個前のページへ
@property (nonatomic, strong) UIButton * _Null_unspecified backButton;
/// 一個後のページへ
@property (nonatomic, strong) UIButton * _Null_unspecified forwardButton;
/// Safariで開く
@property (nonatomic, strong) UIButton * _Null_unspecified openInSafariButton;
/// webViewに表示するTopページのURL
@property (nonatomic, copy) NSURL * _Nullable loadingURLInWeb;
/// 今ローディングしているページ
@property (nonatomic, copy) NSURL * _Nullable currentLoadingPage;
/// 外部での再生を許可するかどうか
...
@property (nonatomic, weak) UIView * _Nullable controlViewForWide;
/// wipe mode時のcontrolView
@property (nonatomic, weak) UIView * _Nullable controlViewForWipe;
...
/// モード切替の有効・無効
@property (nonatomic) BOOL enableToggleMode;
/// Shareボタンの表示
...
/// 共有ボタン
/// @ACCESS_OPEN
SWIFT_CLASS("_TtC9TIGPlayer20TIGPlayerShareButton")
@interface TIGPlayerShareButton : UIButton <UIPopoverPresentationControllerDelegate>
/// Replyモード
...
/// returns:
/// currentTime
- (NSDecimalNumber * _Nonnull)getCurrentTime SWIFT_WARN_UNUSED_RESULT;
/// TIGPlayerを取得
///
/// returns:
/// player
- (TIGPlayer * _Nullable)getPlayer SWIFT_WARN_UNUSED_RESULT;
@end
